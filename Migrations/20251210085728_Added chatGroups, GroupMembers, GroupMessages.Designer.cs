...
namespace RealtimeChat.Migrations
{
    ...
    [Migration("20251210085728_Added chatGroups, GroupMembers, GroupMessages")]
    partial class AddedchatGroupsGroupMembersGroupMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealtimeChat.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RealtimeChat.Models.ChatGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Models.GroupMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RealtimeChat.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RealtimeChat.Models.GroupMember", b =>
                {
                    b.HasOne("RealtimeChat.Models.ChatGroup", "Group")
                        .WithMany("Members")
